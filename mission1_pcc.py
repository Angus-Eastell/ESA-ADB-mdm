...
def main():
    ...
    algorithms = [
        pcc(params=FullParameterGrid({"target_channels": [subset_channels]})),
        #hbos(params=FullParameterGrid({"target_channels": [subset_channels], "n_bins": [50]})),
        #std(params=FullParameterGrid({"target_channels": [subset_channels], "tol": [3, 5]})),
        #iforest(params=FullParameterGrid({"target_channels": [subset_channels]})),
        #subsequence_if(params=FullParameterGrid({"target_channels": [subset_channels], "n_trees": [200], "window_size": [17]})),
        #knn(params=FullParameterGrid({"target_channels": [subset_channels]}))
    ]
